        ...
        <div class="row container">
            ...
            <input type="hidden" name="controller" value="PS5">
                <div class="selectdiv col-md-3">
                    ...
                    <div class="input-group mb-3">
                    <label class="input-group-text col-4 opacity-100" for="inputGroupSelect01">Pad</label>
                    ...
                    <div class="input-group mb-3">
                    <label class="input-group-text col-4 opacity-100" for="inputGroupSelect01">Sides</label>
                ...
                <div class="ps5 row container col-md-4">
                    <img id="button" src="css/btn.png" class="button" height="200px" width="180px">
                    <img id="pad" src="css/pad1.png" class="pad" height="200px" width="180px">
                    <img id="middle" src="css/middle1.png" class="middle" height="200px" width="180px">
                    <img id="sides" src="css/sides1.png" class="sides" height="200px" width="180px">
                </div>
