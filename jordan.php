...
<section id="contact">
        <div class="row container">
            ...
            <input type="hidden" name="shoe" value="jordanone">
                <div class="col-md-3">
                    ...
                    <div class="input-group mb-3">
                    <label class="input-group-text col-4 opacity-100" for="inputGroupSelect01">Outer</label>
                    ...
                    <div class="input-group mb-3">
                    <label class="input-group-text col-4 opacity-100 color-dark" for="inputGroupSelect01">Exterior</label>
                ...
                <div class="shoe row container col-md-4">
                    <img id="sole" src="css/sole3.png" class="sole" height="200px" width="180px">
                    <img id="logo" src="css/nikelogo1.png" class="logo" height="200px" width="180px">
                    <img id="outer" src="css/outer2.png" class="outer" height="200px" width="180px">
                    <img id="exterior" src="css/exterior2.png" class="exterior" height="200px" width="180px">
                </div>
